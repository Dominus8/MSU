                            ...
                            <a id="nav-link-0" class="nav-link swiper-slide" href="{{route('app-product-single-page')}}">
                                <div class="pac-nav__element ">
                                    <div class="nav-element__ico"> 
                                        <!-- <img src="./images/coord_ico.svg" alt="i">  -->
                                        <object type="image/svg+xml" data="./images/coord_ico.svg">
                                          <!-- <img src="picture.png" alt="Фолбэк"> -->
                                        </object>
                                    </div>
                                    <div class="nav-element__title">кек управление транспортными потоками</div>
                                </div>
                            </a>
